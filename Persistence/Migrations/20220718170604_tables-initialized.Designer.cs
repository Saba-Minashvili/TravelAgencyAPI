...
namespace Persistence.Migrations
{
    ...
    [Migration("20220718170604_tables-initialized")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.Apartment", b =>
                {
                    ...
                    b.Property<string>("IsTakenFrom")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("IsTakenTo")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.HasIndex("HostUserId")
                        .IsUnique()
                        .HasFilter("[HostUserId] IS NOT NULL");
            ...
            modelBuilder.Entity("Domain.Entities.Book", b =>
                {
                    ...
                    b.Property<string>("ApartmentImage")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Domain.Entities.BookRequest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domain.Entities.Apartment", b =>
                {
                    b.HasOne("Domain.Entities.User", "User")
                        .WithOne("Apartment")
                        .HasForeignKey("Domain.Entities.Apartment", "HostUserId")
